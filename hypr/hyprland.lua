...
-- Switch focus with mainMod + SHIFT + arrow keys
...
hl.bind(mainMod .. " + PAGE_DOWN", hl.dsp.workspace.toggle_special("magic"))
hl.bind(mainMod .. " + PAGE_UP",   hl.dsp.exec_cmd("~/.config/hypr/toggle-hide.sh"))

-- Screenshot (region select)
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("f=~/Pictures/screenshot-$(date +%s).png; grim -g \"$(slurp)\" \"$f\" && wl-copy < \"$f\""))
